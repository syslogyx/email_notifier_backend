    ...
    <div class="" style="display:inline-block;">          
        <section style="border-top:0px; margin-left: 50px">
            <div style="width: 50%; float: left;">            
				...
				<h1 class="set-title-color" style="font-size: 16px;">Machine '.$machine_name.' is turned "OFF".</h1> 
				<h1 class="set-title-color" style="font-size: 16px;">It will take ".$estimation_hr!=0?$estimation_hr.' hour ':''.{{$estimation_min!=0?$estimation_min}}.' minute':''.to start again </h1> 
				<h1 class="set-title-color" style="font-size: 16px;">Machine '.$machine_name.' is turned "OFF" </h1> 
            </div>
